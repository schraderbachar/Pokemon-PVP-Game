    ...
    for (y = 0; y < MAP_Y; y++)
    {
        for (x = 0; x < MAP_X; x++)
        {
            ...
            else
            {
                ...
                {
                case ter_boulder:
                    waddch(world.w, BOULDER_SYMBOL);
                    break;
                case ter_mountain:
                    waddch(world.w, MOUNTAIN_SYMBOL);
                    break;
                case ter_tree:
                    waddch(world.w, TREE_SYMBOL);
                    break;
                case ter_forest:
                    waddch(world.w, FOREST_SYMBOL);
                    break;
                case ter_path:
                    waddch(world.w, PATH_SYMBOL);
                    break;
                case ter_gate:
                    waddch(world.w, GATE_SYMBOL);
                    break;
                case ter_mart:
                    waddch(world.w, POKEMART_SYMBOL);
                    break;
                case ter_center:
                    waddch(world.w, POKEMON_CENTER_SYMBOL);
                    break;
                case ter_grass:
                    waddch(world.w, TALL_GRASS_SYMBOL);
                    break;
                case ter_clearing:
                    waddch(world.w, SHORT_GRASS_SYMBOL);
                    break;
                case ter_water:
                    waddch(world.w, WATER_SYMBOL);
                    break;
                default:
                    waddch(world.w, ERROR_SYMBOL);
                    default_reached = 1;
                    break;
                }
            }
